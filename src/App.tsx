...
const Navbar = () => (
  <nav className="fixed top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-sm border-b border-gray-100 px-4 py-3 flex justify-between items-center shadow-xs">
    <div className="flex items-center gap-3">
      <img src="/logo.png" alt="Diseña y Crea con Resina" className="h-12 w-12 rounded-full object-cover border-2 border-fuchsia-500" />
      <span className="font-sans font-black text-lg tracking-tighter">DISEÑA Y CREA <span className="text-fuchsia-vibrant">CON RESINA</span></span>
    </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        >
          <div className="space-y-4">
            ...
            <h1 className="text-3xl md:text-4xl font-black leading-[0.95] text-slate-900">
...
const Offer = () => {
  const DURATION = 7200; // 2 horas en segundos
  const hotLink = "https://go.hotmart.com/O105038534Q?ap=1d28";
  ...
  const getTimeLeft = () => {
    ...
    if (stored) {
      ...
      localStorage.setItem('offerExpiry', expiry.toString());
      return DURATION;
    }
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-12 border-b border-white/5 pb-16 mb-12">
        <div className="space-y-4 text-center md:text-left">
           <div className="flex items-center gap-4 justify-center md:justify-start">
             <img src="/logo.png" alt="Diseña y Crea con Resina" className="h-16 w-16 rounded-full object-cover border-2 border-fuchsia-500" />
             <span className="font-sans font-black text-2xl tracking-tighter text-white">DISEÑA Y CREA <span className="text-fuchsia-vibrant">CON RESINA</span></span>
           </div>
